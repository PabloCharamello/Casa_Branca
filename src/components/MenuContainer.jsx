  ...
  return (
    <section className="w-full my-5 " id="Menu">
      <div className="w-full flex flex-col items-center justify-center">
        <p className="text-2x1 font-semibold capitalize text-headingColor relative before:absolute before:rounded-lg before:content before:w-16 before:h-1 before:-bottom-1 mr-auto before:l-0 before:bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in-out duration-100 -mb-3 mt-2">
          Our hot dishes
        </p>
